...
class HangmanGUI:
    ...
    def setup_ui(self):
        ...
        for category in self.categories:
            category_radio = tk.Radiobutton(self.root, text=category, variable=self.category_var, value=category)
            category_radio.pack()
        
        self.next_button = tk.Button(self.root, text="Next", command=self.select_difficulty)
    ...
    def select_difficulty(self):
        ...
        self.difficulty_label = tk.Label(self.root, text="Choose the level of difficulty:")
        ...
        for difficulty in self.difficulties:
            difficulty_radio = tk.Radiobutton(self.root, text=difficulty, variable=self.difficulty_var, value=difficulty)
    ...
    def start_game(self):
        ...
        self.attempts_label = tk.Label(self.root, text="Attempts left: {}".format(self.attempts_left))
        self.attempts_label.pack()
        
        self.word_label = tk.Label(self.root, text="Word: {}".format(self.get_masked_word()))
